...
namespace LangID {
    enum LangID {
        ...
        CUSTOM_SIZE_TEXT,
        CUSTOM_SIZE_TITLE,
        ERROR_CHANGING_SIZE_TEXT,
        ERROR_CHANGING_SIZE_TITLE,        
        ERROR_STARTING_NEWGAME_TEXT,
        ERROR_STARTING_NEWGAME_TITLE,
        ERROR_WRITE_SETTINGS_TEXT,
        ERROR_WRITE_SETTINGS_TITLE,        
        ERROR_WRITE_SCORES_TEXT,
        ERROR_WRITE_SCORES_TITLE,
        ERROR_TILESET_MISSING_TEXT,
